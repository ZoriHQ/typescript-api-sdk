...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['ZORIAPI_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ZORIAPI_LOG'] or 'warn' if it isn't set.
   */
...
export class Zoriapi {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Zoriapi.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ZORIAPI_LOG'), "process.env['ZORIAPI_LOG']", this) ??
      defaultLogLevel;
  ...
  static ZoriapiError = Errors.ZoriapiError;
...
export declare namespace Zoriapi {
