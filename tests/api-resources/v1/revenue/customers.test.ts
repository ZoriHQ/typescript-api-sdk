...
describe('resource customers', () => {
  ...
  test.skip('profile: only required params', async () => {
    const responsePromise = client.v1.revenue.customers.profile({
  ...
  test.skip('profile: required and optional params', async () => {
    const response = await client.v1.revenue.customers.profile({
      project_id: 'project_id',
      visitor_id: 'visitor_id',
    });
  });
  ...
  test.skip('top: only required params', async () => {
    const responsePromise = client.v1.revenue.customers.top({
      project_id: 'project_id',
  ...
  test.skip('top: required and optional params', async () => {
    const response = await client.v1.revenue.customers.top({
      project_id: 'project_id',
      time_range: 'last_hour',
      limit: 0,
    });
